...
data "aws_availability_zones" "availible_zones" {
...
resource "aws_subnet" "pub_sub_1a" {
    ...
    availability_zone = data.aws_availability_zones.availible_zones.names[0]
...
resource "aws_subnet" "pub_sub_2b" {
  ...
  availability_zone = data.aws_availability_zones.availible_zones.names[1]
  map_public_ip_on_launch = true
